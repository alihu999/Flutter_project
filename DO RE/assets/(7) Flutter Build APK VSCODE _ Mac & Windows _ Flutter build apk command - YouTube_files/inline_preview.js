(function(g){var window=this;'use strict';var xpb=function(a){g.U.call(this,{I:"div",S:"ytp-inline-preview-ui"});this.jg=!1;this.player=a;this.T(a,"onStateChange",this.UR);this.T(a,"videodatachange",this.xx);this.T(a,"onInlinePreviewModeChange",this.f7);this.xf=new g.zu(this.Dw,null,this);g.L(this,this.xf)},G6=function(a){g.xV.call(this,a);
this.j=new xpb(this.player);g.L(this,this.j);this.j.hide();g.sU(this.player,this.j.element,4);a.isInline()&&(this.load(),a=a.getRootNode(),g.Ku(a,["ytp-inline-preview-mode","ytp-no-contextmenu"]))};
g.w(xpb,g.U);g.k=xpb.prototype;
...
g.k.Cr=function(a,b,c,d,e){var f=0,h=d=0,l=g.fs(a);if(b){c=g.Iu(b,"ytp-mute-button");var m=g.Iu(b,"ytp-subtitles-button");f=g.ds(b,this.element);g.fs(b);f=f.y+40;if(m||c)h=8}else h=c-l.width/2,d=35;b=this.player.kb().getPlayerSize().width;b=g.me(h,0,b-l.width);f?(a.style.top=f+(e||0)+"px",a.style.bottom=""):(a.style.top="",a.style.bottom=d+"px");a.style.left=b+"px"};
